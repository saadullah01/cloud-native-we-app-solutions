...
pexpect.run("cp "+sol_dir+"Nav.svelte "+cmd_dir+"services/web/src/components/")
pexpect.run("cp "+sol_dir+"auth-nav-item.svelte "+cmd_dir+"services/web/src/components/")
pexpect.run("cp -r "+sol_dir+"admin "+cmd_dir+"services/web/src/routes/")
pexpect.run("cp -r "+sol_dir+"auth "+cmd_dir+"services/web/src/routes/")
pexpect.run("git add .", cwd=cmd_dir)
pexpect.run("git commit -m 'Create login and admin page.'", cwd=cmd_dir)
