...
pexpect.run("rm -rf .github/workflows/services-web-deploy.yml", cwd=cmd_dir)
pexpect.run("cp "+sol_dir+"services-web.yml "+cmd_dir+".github/workflows/")
pexpect.run("git add .", cwd=cmd_dir)
pexpect.run("git commit -m 'Enable Tests in the Continuous Integration Pipeline'", cwd=cmd_dir)
