...
pexpect.run("cp -r "+sol_dir+"src "+cmd_dir+"services/web/firebase/functions/")
pexpect.run("cp "+sol_dir+"tsconfig.json "+cmd_dir+"services/web/firebase/functions/")
pexpect.run("cp "+sol_dir+"package.json "+cmd_dir+"services/web/firebase/")
pexpect.run("git add .", cwd=cmd_dir)
pexpect.run("git commit -m 'Test the Default Cloud Function Locally'", cwd=cmd_dir)
